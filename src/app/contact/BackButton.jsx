...
export default function BackButton() {
    ...
    return (
        <Link href="/" ref={buttonRef} className="opacity-0 flex items-center gap-1 mt-8 md:mt-12 xl:mt-14 font-figtree text-white">
            <svg className="size-5 fill-white" width="80px" height="80px" viewBox="0 0 512 512" >
