...
export default function IconStar({ size = '40px', fill = 'fill-yellow-200', className = '' }) {
    return (
        <svg
            ...
            <g>
                <path
                    d="M358.966,143.652c0-11.38-9.047-20.582-20.183-20.582c-0.301,0-0.602,0.024-0.894,0.041
