...
export default function HomeLogo() {
    ...
    return (
        <Link href="/" className="flex flex-col gap-4 items-center mb-10 md:mb-14">

            <Image src="/logo.png" alt="Logo Simon TESSARD"
                   ref={logoRef}
                   aria-label="Retour à l'accueil"
                   width={100} height={100}
                   className="opacity-0 scale-90 size-13 md:size-15 bg-gradient-to-r from-blue-700 to-blue-primary rounded-md p-1"/>

            <span ref={textRef} className="opacity-0 translate-y-1 flex items-center gap-1 font-figtree text-sm text-white">
                <svg className="size-4 fill-white" width="80px" height="80px" viewBox="0 0 512 512" >
