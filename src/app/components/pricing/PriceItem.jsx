            ...
            <div className="flex flex-col justify-between">
                <div className={[ 'rounded-xl mb-4 md:mb-6 p-4 md:p-5 shadow-sm', popular ? 'bg-white' : 'bg-white-primary'].join(' ')}>
                    ...
                    <div className="flex justify-between mb-2.5 md:mb-3">
                        ...
                        {popular && (
                          <p className="size-fit bg-gradient-to-r from-blue-600 to-theme-primary text-white font-figtree py-1 md:py-1.25 px-2 md:px-2.5 text-xs md:text-sm rounded-md">
                             La + populaire
                          </p>
                        )}
                    </div>
