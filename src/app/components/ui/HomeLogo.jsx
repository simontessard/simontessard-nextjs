...
export default function HomeLogo() {
    ...
    return (
        <Link href="/" className="flex flex-col gap-4 items-center mb-10 md:mb-14">
            ...
            <span ref={textRef} className="opacity-0 translate-y-1 flex items-center gap-1 font-figtree text-sm text-black">
                <svg className="size-4 fill-black" width="80px" height="80px" viewBox="0 0 512 512" >
