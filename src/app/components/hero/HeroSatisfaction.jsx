    ...
    return (
        ...
        >
            <div className="relative w-24 flex">
                <img
                    src="/placeholders/client-maxime.jpg"
                    alt=""
                ...
                />
                <div
                    className="js-hero-satisfaction--bull scale-60 opacity-0 -translate-x-20 shrink-0 font-figtree text-xs flex items-center justify-center rounded-full
