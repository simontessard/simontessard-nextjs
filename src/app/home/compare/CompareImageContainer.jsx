"use client";
import { Compare } from "@/app/home/compare/Compare";
import { useEffect } from "react";
import { gsap } from "gsap";
import Card from "@/app/home/compare/Card";
...
export default function CompareImageContainer() {
    ...
    return (
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-y-6 gap-x-4">
            ...
            {/* Avant/Après central */}
            <div className="compare-image--container xl:col-span-2 opacity-0 p-0.5 border border-neutral-800 rounded-2xl bg-gradient-primary shadow-lg">
                <Compare
